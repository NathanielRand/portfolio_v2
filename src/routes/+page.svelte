			...
			<div class="container rounded-xl bg-primary-50 mx-4 md:ml-6 md:mr-20 px-0 lg:px-36 w-full md:w-3/5 h-3/6 md:h-fit ring-1 ring-primary-50 ring-offset-8 ring-offset-primary-200">
				<div class="grid grid-cols-2">
					<div class="col-span-2 md:col-span-1">
						...
						<h2 class="subpixel-antialiased text-6xl md:text-8xl text-primary-100 font-black text-center md:text-start my-8 md:my-12 md:my-4 ml-1.5 md:ml-0 tracking-tight hover:text-accent-100 hover:scale-125">Nathaniel <br><custom class="text-primary-200 text-8xl md:text-9xl">Rand</custom></h2>
						...
						<div class="flex justify-center md:justify-start pt-6 md:pt-12">
						...
						<svg class="block md:hidden w-10 h-10 mx-auto mt-12 hover:scale-125 text-white" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
