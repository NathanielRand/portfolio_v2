			...
			<div class="container rounded-xl bg-primary-50 -mt-48 md:-mt-0 mx-4 md:ml-6 md:mr-20 px-0 lg:px-36 w-full md:w-3/5 h-3/6 md:h-fit ring-1 ring-primary-50 ring-offset-8 ring-offset-primary-200">
				<div class="grid grid-cols-2">
					<div class="col-span-2 md:col-span-1">
						<p class="opacity-90 text-center md:text-start text-3xl md:text-6xl mt-8 md:mt-12 mb-4 md:mb-10 font-black text-primary-200 ml-4 md:ml-0">Full Stack Developer</p>
						...
						<div class="flex flex-wrap h-20 md:h-28 lg:h-18 md:w-full py-2 md:py-4 mt-6 mx-2 md:mx-0 bg-primary-100 rounded-xl px-1 justify-center">
						...
						<div class="flex justify-center md:justify-start pt-12 md:pt-12">
						...
						<svg class="block md:hidden w-10 h-10 mx-auto mt-7 hover:scale-125 text-white" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
							<path stroke-linecap="round" stroke-linejoin="round" d="M19.5 13.5 12 21m0 0-7.5-7.5M12 21V3"></path>
						</svg>
					</div>
					<div>
						<img alt="nathanielrand" src={nathanielrand_hero} class="z-0 hidden md:block pb-9 mt-[4.3em] ml-28 scale-150 border border-primary-50 ring-1 ring-primary-200 ring-offset-8 ring-offset-transparent rounded-xl">
					</div>
	...
	<section id="section-3" data-color="secondary-100">
		<div class="snap-center bg-primary-100 h-screen flex items-center justify-center text-8xl">
			<div class="grid grid-cols-12">
				<div class="col-span-12">
					<a href="/#section-4">
						<svg class="text-secondary-100 hover:text-primary-50 ml-4 w-20 h-20 md:w-24 md:h-24 mt-0 md:mt-14 mb-8 md:mb-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="0.4" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75l3 3m0 0l3-3m-3 3v-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
						</svg>			
					</a>			  
					<a href="https://remotejobs.guru" target="_blank">
						<h3 class="text-4xl md:text-7xl text-secondary-100 hover:text-primary-50 hover:overline hover:decoration-accent-100 font-black text-end mb-16 md:mb-20 mr-2 md:mr-0">
							Remote Job Guru <custom class="font-thin text-accent-100">|</custom>
						</h3>
					</a>
				</div>
				<div class="col-span-12 md:col-span-6 -mt-8">
					<h4 class="text-4xl md:text-5xl font-black mb-5 md:mb-6 text-secondary-100 text-end md:text-start mr-4">Job Board</h4>
					<h4 class="text-2xl md:text-3xl font-thin mb-6 text-white overline decoration-accent-100 decoration-2 text-end md:text-start mr-4 uppercase opacity-50">Tech Stack</h4>
					...
					<div class="relative md:mr-16 mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[16px] rounded-t-xl h-[172px] max-w-[301px] md:h-[294px] md:max-w-[512px]">
					...
					<div class="relative md:mr-16 mx-auto bg-gray-900 dark:bg-gray-700 rounded-b-xl h-[24px] max-w-[301px] md:h-[42px] md:max-w-[512px]"></div>
					<div class="relative md:mr-60 mx-auto bg-gray-800 rounded-b-xl h-[55px] max-w-[83px] md:h-[95px] md:max-w-[142px]"></div>
				</div>
	...
	<section id="section-4" data-color="accent-100">
		<div class="snap-center bg-secondary-100 h-screen flex items-center justify-center text-8xl">
			<div class="grid grid-cols-12">
				<div class="col-span-12">
					<a href="/#section-5">
						<svg class="text-accent-100 hover:text-primary-100 ml-4 w-20 h-20 md:w-24 md:h-24 mt-0 md:mt-14 mb-8 md:mb-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="0.4" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75l3 3m0 0l3-3m-3 3v-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
						</svg>		
					</a>				  
					<a href="https://morebytes.io" target="_blank">
						<h3 class="text-5xl md:text-7xl text-accent-100 hover:text-primary-100 hover:overline hover:decoration-primary-200 font-black text-end mb-16 md:mb-20 mr-2 md:mr-0">
	...
	<section id="section-5" data-color="primary-100">
		<div class="snap-center bg-accent-100 h-screen flex items-center justify-center text-8xl">
			<div class="grid grid-cols-12">
				<div class="col-span-12">
					<a href="/#section-6">
						<svg class="text-primary-100 hover:text-primary-200 ml-4 w-20 h-20 md:w-24 md:h-24 mt-0 md:mt-14 mb-8 md:mb-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="0.4" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75l3 3m0 0l3-3m-3 3v-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
						</svg>		
					</a>				  
					<a href="https://kqmgmt.co" target="_blank">
						<h3 class="text-5xl md:text-7xl text-primary-100 hover:text-primary-200 hover:overline hover:decoration-secondary-100 font-black text-end mb-16 md:mb-20 mr-2 md:mr-0">
